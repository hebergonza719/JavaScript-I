...
console.log(`This car's make is ${lastCar.car_make} and its model is ${lastCar.car_model}`);
...
//this for loop prints the list without repeats

for (let i = 0; i < carModelsSorted.length; i++) {
  if (carModelsSorted[i] != carModelsSorted[i - 1] ) {
...
//Using .map to get the list of car years

// let carYears = inventory.map(function (item) {
// 	return item.car_year;
//   }
// );

let uniqueYears = carYears.filter(function(item, index) {
  return carYears.indexOf(item) >= index;
});
console.log('Below you will find the full list of car years.')
console.log(carYears);
console.log('-------------------------');
console.log('Below you will find the list of car years without repeats.')
